...
from app.routers import admin_briefing, admin_chat, admin_data, admin_failures, admin_kg, admin_presets, admin_research, admin_self_correction, admin_supreme, api_keys_admin, auth, billing, documents, nai, predictions, transcribe, tts, v1
