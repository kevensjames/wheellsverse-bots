...
def verify_password(plain: str) -> bool:
    ...
    # Truncate to 72 bytes: bcrypt 3.x silently truncated; bcrypt 4.x raises
    # ValueError instead. Explicit truncation keeps both versions consistent
    # and verifies correctly against hashes generated by either version.
